...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # SuperOdom SLAM for simulation (bag replay)
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(super_odometry_dir, 'launch', 'superodom_autonomy_sim.launch.py')
            )
        ),
        ...
        IncludeLaunchDescription(
            AnyLaunchDescriptionSource(
                os.path.join(terrain_analysis_ext_dir, 'launch', 'terrain_analysis_ext.launch')
            ),
            launch_arguments={
        ...
        IncludeLaunchDescription(
            AnyLaunchDescriptionSource(
                os.path.join(far_planner_dir, 'launch', 'far_planner.launch')
            )
        ),
    ])
