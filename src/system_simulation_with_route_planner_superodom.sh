#!/bin/bash
# Launch script for SIMULATION with Route Planner using SuperOdom (Livox Mid360)
# 
# Usage:
...
ros2 launch vehicle_simulator system_simulation_with_route_planner_superodom.launch.py

# ros2 launch vehicle_simulator system_simulation_with_route_planner_superodom.launch.py sensorOffsetX:=0.35 sensorOffsetY:=0.05
